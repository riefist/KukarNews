...
public class PengumumanFragment extends Fragment {
    ...
    public final static String TAG = "PengumumanFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url = "http://kutaikartanegarakab.go.id/ws_portal_kukar/index.php/api/webservice/channeltitle_channelid/id/6";
